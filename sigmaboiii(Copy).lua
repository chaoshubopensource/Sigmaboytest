...
pcall(function()
    HouseTab:AddToggle({
        ...
        Default = false,
        Callback = function(Value)
            getgenv().Sigma Boy HubAutoSpawnDoorbellValue = Value
            spawn(function()
                while getgenv().Sigma Boy HubAutoSpawnDoorbellValue do
                    local House = workspace["001_Lots"]:FindFirstChild(tostring(SelectHouse))
                    if House and House:FindFirstChild("HousePickedByPlayer") then
...
pcall(function()
    HouseTab:AddToggle({
        ...
        Default = false,
        Callback = function(Value)
            getgenv().Sigma Boy HubAutoSpawnDoorValue = Value
            spawn(function()
                while getgenv().Sigma Boy HubAutoSpawnDoorValue do
                    local House = workspace["001_Lots"]:FindFirstChild(tostring(SelectHouse))
                    if House and House:FindFirstChild("HousePickedByPlayer") then
...
getgenv().Sigma Boy HubEnviarDelay = 1
...
LocalPlayerTab:AddSlider({
    ...
    Increment = 0.1,
    Callback = function(Value)
        getgenv().Sigma Boy HubEnviarDelay = Value
    end
})
...
LocalPlayerTab:AddToggle({
    ...
    Callback = function(Value)
        getgenv().Sigma Boy HubSpawnText = Value
        while getgenv().Sigma Boy HubSpawnText do
            sendchat(TextSave)
            task.wait(getgenv().Sigma Boy HubEnviarDelay)
        end
    end
})
